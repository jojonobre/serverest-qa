...
- Name: register.spec.ts >> US002 - Cadastrar Usuário >> CT006 - Cadastro com sucesso sem atribuição de Administrador
- Location: tests\register.spec.ts:19:7
...
- generic [ref=e5]:
  ...
  - textbox "Digite seu nome" [ref=e9]: Usuário Comum
  - textbox "Digite seu email" [active] [ref=e11]: user_comum_1784902382925@qa.com
