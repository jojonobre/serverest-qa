...
- Name: register.spec.ts >> US002 - Cadastrar Usuário >> CT008 - Cadastrar com e-mail já utilizado
- Location: tests\register.spec.ts:33:7
...
- generic [ref=e5]:
  ...
  - textbox "Digite seu nome" [ref=e9]: Fulano QA
  - textbox "Digite seu email" [active] [ref=e11]: fulano@qa.com
